                ...
                <div className="pb-12 md:pb-20">
                    <div className="max-w-2xl mx-auto text-center">
                       ...
                       <p className="text-xl text-white-400 mb-8" data-aos="fade-up" data-aos-delay="200">
                            My name is <span className='font-bold text-2xl'>Kunal</span>, and I am an engineer with skills in <span className='font-bold text-white'>Software Engineering</span>, <span className='font-bold text-white'>Data Engineering</span>,  and  <span className='font-bold text-white'>Design</span>.
                        </p>
                    </div>
                    <br />
