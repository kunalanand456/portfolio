      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
            ...
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-tabs]">I have a variety of engineering experiences at different companies </p>
          </div>
          {/* Section content */}
          <div>
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-black py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      ...
                      <p> At <span className='font-bold'>CleverTap</span>, I developed an e-commerce app for iOS and Android using Swift and Java, integrating the CleverTap SDK to track and
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-black-800 py-8 md:py-16 px-6 md:p l-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      ...
                      <p> At <span className='font-bold'>Viddl</span>, I worked on training an AI model to accurately condense videos and summarize long-form videos into short videos. I also oversaw the video production for the final edits of updated videos. </p>
                      <br></br>
                      <ul className="flex flex-wrap text-sm text-gray-400 -mx-2 -my-2">
                        <li className="flex items-center mx-3 my-1" data-aos="fade-up" data-aos-delay="800" data-aos-anchor="[data-aos-id-cta]">
                ...
                >
                  ...
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-black-800 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
                      ...
                      <p> At <span className='font-bold'>GoEzz</span>, I led the design and development of the primary website within a 5-member team, utilizing React and JavaScript for
development. </p>
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <h4 className="h4 mb-2">Data Science Engineer Intern</h4>
                      ...
                      <p> At <span className='font-bold'>dealpad</span>, I utilized advanced SQL queries to extract relevant data from the company database, aligning it with the defined customer success metrics.</p>
                ...
                >
                  ...
                  <figure className="flex justify-center items-center md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    ...
                    <h4 className="h4 mb-2">Software Engineer Intern</h4>
                      ...
                      <p> At <span className='font-bold'>M2</span>, I helped with the transition of .ASPX web pages to modern, responsive web interfaces, enhancing user experience and accessibility. I personally designed and developed a personalized Patient Relative webpage, tailored to individual hospital requirements. </p>
                      <br />
                      <ul className="flex flex-wrap text-sm text-gray-400 -mx-2 -my-2">
                        <li className="flex items-center mx-3 my-1" data-aos="fade-up" data-aos-delay="800" data-aos-anchor="[data-aos-id-cta]">
                          <svg className="w-3 h-3 text-purple-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
