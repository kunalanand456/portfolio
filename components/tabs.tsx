                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="relative bg-black py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      <h4 className="h4 mb-2">Capstone Project</h4>
                      ...
                      <p className="text-lg "> At <span className='font-bold'>LifePattern.AI</span>, I worked as a product designer in a dynamic team of four, driving the development of a web-based journey creation tool, leveraging my expertise in NextJS, NestJS, and TypeScript, along with my experience in user-centered design, to deliver a cross-platform user experience. </p>
                      <br />
